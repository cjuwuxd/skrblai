...
def evaluate(image):
    ...
    if config.mode == 1:
        ...
        prompt_explain = f"Analyze the image, and explain how to solve it without giving the final answer, and give a step by step explanation on how to solve it {user_input}"
